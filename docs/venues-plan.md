...
| **A6** | Fill the §3 enrichment checklist for the 88 P1+P2 leads to `medium`+ confidence. Manual. | 3–5 d | **P1 chains done 2026-08-15** (14/14). **P1 non-chain dedicated centres done 2026-08-15** (ATC, Ace, Pro1, Roketto, Yennora, KBC Camellia, APX Thornleigh, A1 Campbelltown — 8/8, `scripts/venues/enrich-p1-nonchain.mjs`, migration `20260815001600`). 22 of 37 P1 leads now enriched. Remaining: 9 community halls (Muirfield HS cluster etc.) + the rest of P1's multi-purpose bucket + the 51-venue P2 queue — **the long pole remains** |
