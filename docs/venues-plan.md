...
>   confirmed no-badminton or duplicate and deliberately left out. **Corrected 2026-09-12:
>   directory covers 75 venues, not ~98 or 56.** The ~98 figure (stated here 2026-08-17 → 2026-09-12)
>   was bad arithmetic, 56 + 21 ≠ 98; the 56 figure is the older 2026-08-15 snapshot. 75 is the
>   confirmed production count. Both stale numbers are repeated in [AGENTS.md](../AGENTS.md),
>   [gtm-plan.md](gtm-plan.md) (G9, G11, §2), [quick-wins.md](quick-wins.md) and
>   [website-plan.md](website-plan.md) — treat any of those not yet carrying this correction as stale.
...
| **A6** | Fill the §3 enrichment checklist for the 88 P1+P2 leads to `medium`+ confidence. Manual. | 3–5 d | **P1 chains done 2026-08-15** (14/14). **P1 non-chain dedicated centres done 2026-08-15** (ATC, Ace, Pro1, Roketto, Yennora, KBC Camellia, APX Thornleigh, A1 Campbelltown — 8/8, `scripts/venues/enrich-p1-nonchain.mjs`, migration `20260815001600`). **P1 school/community halls done 2026-08-15** (8/9 — Muirfield HS, Epping Boys HS, Hurstville Boys HS, Dulwich Hill HS Hall, Baulkham Hills HS Gym, Castle Hill HS, Erskine Park HS, Glenbrook PS; `scripts/venues/enrich-p1-halls.mjs`, migration `20260815001700`. UNSW Gymnasium deliberately not inserted — its Places geocode collides with the already-existing UNSW FAC venue's place_id, so it got an access_notes addendum on that row instead of a duplicate. Hurstville Boys HS is the same site as P1 lead "Sydney Badminton" — that lead was skipped, not separately inserted). **P1 multi-purpose bucket done 2026-08-15** (9 of 13 leads inserted — Ryde Aquatic, Macquarie University Sport and Aquatic Centre, Morris Iemma Indoor Sports Centre, North Sydney Indoor Sports Centre, PCYC Northern Beaches, Avalon Recreation Centre, Curl Curl Youth and Community Centre, Taren Point Youth Centre, Macquarie Fields Fitness & Indoor Sports Centre; `scripts/venues/enrich-p1-multi.mjs`, migration `20260815002200`. 4 leads dropped after research: Macquarie Fields Leisure Centre — pool only, no badminton; Curl Curl Sports Centre + North Curl Curl Community Centre — no independent badminton confirmation, likely same site as Curl Curl Youth and Community Centre; Macquarie University Sports Fields — outdoor fields only). **All 37 P1 leads now enriched.** **P2 done 2026-08-17** (46 of 51 queue rows actually live: 5 were stale re-listings of NBC sites already done in the P1 chain pass. Researched via 6 parallel WebSearch/WebFetch agents, migration `20260817000200`, script `scripts/venues/enrich-p2.mjs`. 21 new venues, 9 existing low-confidence rows upgraded to medium/high, 16 confirmed to have no badminton or be exact duplicates and deliberately not inserted — see the migration's header comment for the full list). **Corrected 2026-09-12: directory covers 75 venues, not ~98** — the ~98 figure was bad arithmetic (56 + 21 ≠ 98); confirmed by direct query against production. Remaining: 238 P4-bucket leads in the queue are low-precision Places sweep hits (broad venue-type queries, not badminton-specific) — mostly noise, not yet triaged for a P3 pass |
